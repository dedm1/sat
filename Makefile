#############################################################################
# Makefile for building: laba_SAT1
# Generated by qmake (3.1) (Qt 5.15.8)
# Project:  laba_SAT1.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile laba_SAT1.pro
#############################################################################
...
INCPATH       = -I. -I/usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = laba_SAT11.0.0
DISTDIR = /home/dedm/data/sat1/SATlab1/laba_SAT1/.tmp/laba_SAT11.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		NodeBoolTree.h \
		boolequation.h \
		boolinterval.h BBV.cpp \
		boolequation.cpp \
		boolinterval.cpp \
		main.cpp
QMAKE_TARGET  = laba_SAT1
DESTDIR       = 
TARGET        = laba_SAT1
...
Makefile: laba_SAT1.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		laba_SAT1.pro
	$(QMAKE) -o Makefile laba_SAT1.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents BBV.h NodeBoolTree.h boolequation.h boolinterval.h $(DISTDIR)/
	$(COPY_FILE) --parents BBV.cpp boolequation.cpp boolinterval.cpp main.cpp $(DISTDIR)/
...
BBV.o: BBV.cpp BBV.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o BBV.o BBV.cpp

boolequation.o: boolequation.cpp boolequation.h \
		boolinterval.h \
		BBV.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o boolequation.o boolequation.cpp

boolinterval.o: boolinterval.cpp boolinterval.h \
		BBV.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o boolinterval.o boolinterval.cpp

main.o: main.cpp BBV.h \
		NodeBoolTree.h \
		boolinterval.h \
		boolequation.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/laba_SAT1/bin || mkdir -p $(INSTALL_ROOT)/opt/laba_SAT1/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/laba_SAT1/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/laba_SAT1/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/laba_SAT1/bin/ 
