...
BoolInterval & BoolInterval::operator=(BoolInterval & ibv)
{
...
bool BoolInterval::isOrthogonal(BoolInterval & ibv)
{
    ...
    BBV tmpV(zero);
    BBV answer(zero);
    //cout << (string)dnc << " " << (string)ibv.dnc << endl;
...
BoolInterval & BoolInterval::mergeInterval(BoolInterval & ibv)
{
...
bool BoolInterval::isIntersection(BoolInterval & ibv)
{
    //Если требуется, реализовать самостоятельно
...
bool BoolInterval::isAbsorb(BoolInterval & ibv)
{
    //Если требуется, реализовать самостоятельно
